...
df_1h_subset <- select_vector(rnaseq_1h, gene_set$V1)
base::setdiff(gene_set$V1, df_1h_subset$X) #"AT1G22810" its gene that we dont have in 1h RNA-seq
subset_1h <- make_deg(df_1h_subset[, c(1, 3, 7)], yname = 'RNAseq_logFC_1h')
df_6h_subset <- select_vector(rnaseq_6h, gene_set$V1) 
